        ...
        <div className="w-full bg-slate-50 dark:bg-zinc-950 flex flex-col items-center pb-20">
            ...
            <section className="w-full max-w-5xl px-4 py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-emerald-500/50 transition-colors group">
                        <div>
                    ...
                    <div className="rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-8 hover:border-indigo-500/50 transition-colors">
                    ...
                    <div className="rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-8 hover:border-orange-500/50 transition-colors">
                    ...
                    <div className="md:col-span-2 rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-8 flex flex-col justify-between hover:border-blue-500/50 transition-colors">
                        <div>
            ...
            <section className="w-full bg-slate-900 dark:bg-zinc-900 py-24 px-4 my-12 relative overflow-hidden">
